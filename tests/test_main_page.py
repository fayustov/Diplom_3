...
class TestMainPage:
    ...
    @allure.title('Тест условия залогиненный пользователь может оформить заказ')
    ...
    @allure.title('Тест на появление модального окна с подробностями при нажатии на ингредиент')
